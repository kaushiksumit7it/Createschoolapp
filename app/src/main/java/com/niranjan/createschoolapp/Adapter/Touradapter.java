...
import com.niranjan.createschoolapp.Model.Tourmodel;
...
public class Touradapter extends RecyclerView.Adapter<Touradapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Touradapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.tour,parent,false));
